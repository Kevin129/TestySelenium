...
public class ebutikZamowienie {
    ...
    public void shop() {
        ...
        WebElement przejdzDoPlatnosci = driver.findElement(By.linkText("Przejdź dalej"));
        przejdzDoPlatnosci.click();

        WebElement regulamin = driver.findElement(By.xpath("//i{contains(text(), 'Akceptuję warunki')]"));
        regulamin.click();

        WebElement umowa = driver.findElement(By.xpath("//i{contains(text(), 'Zapoznałem się z moim')]"));
        umowa.click();
    }
}
